...
def main ():
     ...
     #Lista de secciones para llevar un control de qué secciones están activas
    secciones = ["S","T","A","E"]
    ...
    filepath = 'prueba4-1.txt' # Ruta del archivo que se va a leer
    ...
    with open(filepath, 'r') as archivo:
        for numero_fila, linea in enumerate(archivo, start=1): # `start=1` para contar las líneas desde 1
            ...
            if numero_fila ==  i:  # Si estamos en la primera línea
                ...
                #Elimina los espacios presentes en la cadena
            ...
            if secciones[3] == False:#Si no se encontró la sección ERROR
                #Muestra error
                columna_error = 1
